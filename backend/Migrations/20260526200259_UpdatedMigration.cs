        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastTokenReset = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Conversation_UserOrder", "\"UserLowId\" < \"UserHighId\"");
                    table.ForeignKey(
                        name: "FK_Conversations_Users_UserHighId",
                        column: x => x.UserHighId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Conversations_Users_UserLowId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_UserHighId",
                table: "Conversations",
                column: "UserHighId");

            migrationBuilder.CreateIndex(
                name: "IX_Conversations_UserLowId_UserHighId",
                table: "Conversations",
